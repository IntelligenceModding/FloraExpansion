...
public class ModFoods {
    ...
    public static final FoodProperties BLUEBERRIES = (new FoodProperties.Builder()).nutrition(1).saturationModifier(0.3F).fast().build();
    public static final FoodProperties BLUEBERRY_COOKIE = (new FoodProperties.Builder()).nutrition(2).saturationModifier(0.25F).fast().build();
    public static final FoodProperties BLUEBERRY_PIE = (new FoodProperties.Builder()).nutrition(8).saturationModifier(0.3F).build();
    public static final FoodProperties BLUEBERRY_PIE_SLICE = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.4F).build();
    public static final FoodProperties BLUEBERRY_JUICE = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.45F).build();
    public static final FoodProperties BLUEBERRY_JAM = (new FoodProperties.Builder()).nutrition(5).saturationModifier(0.55F).build();
    public static final FoodProperties STRAWBERRY = (new FoodProperties.Builder()).nutrition(1).saturationModifier(0.3F).fast().build();
    public static final FoodProperties STRAWBERRY_JAM = (new FoodProperties.Builder()).nutrition(5).saturationModifier(0.55F).build();
