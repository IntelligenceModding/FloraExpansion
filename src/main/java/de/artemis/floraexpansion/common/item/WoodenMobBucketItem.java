...
public class WoodenMobBucketItem extends MobBucketItem {
    public WoodenMobBucketItem(EntityType<?> entityType, net.minecraft.sounds.SoundEvent emptySound, Properties properties) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        return InteractionResultHolder.sidedSuccess(emptiedResult, level.isClientSide());
    }
}
