...
public class PineConeProjectile extends ThrowableItemProjectile {
    ...
    public PineConeProjectile(EntityType<? extends PineConeProjectile> entityType, Level level) {
        super(entityType, level);
    }

    public PineConeProjectile(Level level, LivingEntity shooter, ItemStack stack) {
        super(EntityTypes.SNOWBALL, shooter, level, stack);
    }

    public PineConeProjectile(Level level, double x, double y, double z, ItemStack stack) {
        super(EntityTypes.SNOWBALL, x, y, z, level, stack);
    }
    ...
    protected void onHitEntity(@NotNull EntityHitResult result) {
        ...
        if (entity instanceof LivingEntity livingEntity) {
            livingEntity.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 60, 0));
        }
