...
public class PineLeafFluffParticles extends SingleQuadParticle {
    private final SpriteSet spriteSet;

    protected PineLeafFluffParticles(ClientLevel level, double x, double y, double z, SpriteSet spriteSet,
    ...
    public static class Provider implements ParticleProvider<@NotNull SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(@NotNull SimpleParticleType simpleParticleType,
            ...
            return new PineLeafFluffParticles(clientLevel, x, y, z, this.spriteSet, xSpeed, ySpeed, zSpeed);
        }
    }
}